...
<head>
    ...
    <link rel="preconnect" href="frontend/https://fonts.gstatic.com" crossorigin>
    <link
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            @foreach ($services as $key => $service)
                                <a href="{{ route('serviece-new', ['slug' => $service->slug]) }}"
                    ...
                    <a href="{{ route('all.service') }}"
                        class="nav-item nav-link {{ Request::routeIs('all.service') ? 'active' : '' }}">Service</a>
