@include('layouts.fpartial.header')
...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            ...
            <a href="{{ route('serviece-new', ['slug' => $service->slug]) }}" class="h5 text-white">{{$service->name}}</a>
        </div>
    </div>
</div>
</div>
                ...
                <div class="col-md-6 wow slideInUp"   data-wow-delay="0.1s">
                    <div class="blog-item bg-light rounded overflow-hidden" >
                        <div class="blog-img position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('uploads/project/'.$project->image)}}" alt="">
        ...
        <div class="col-lg-4">
            ...
            <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                ...
                <div class="link-animated d-flex flex-column justify-content-start">
                    <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{ route('serviece-new', ['slug' => $service->slug]) }}"><i class="bi bi-arrow-right me-2"></i>{{$service->name}}</a>
...
@include('layouts.fpartial.footer')
